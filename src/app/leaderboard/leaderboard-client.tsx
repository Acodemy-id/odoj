...
import { Trophy, Calendar, Moon, Medal, Sparkles } from "lucide-react";
            ...
            <main className="max-w-2xl mx-auto px-4 py-6 space-y-4">
                <Tabs value={tab} onValueChange={setTab} className="w-full">
                    <TabsList className="grid w-full grid-cols-2 bg-emerald-100/50">
                        <TabsTrigger
                            value="daily"
                            className="data-[state=active]:bg-emerald-600 data-[state=active]:text-white font-semibold gap-1"
                        >
